...
\input{C_Inhalt/02_Theorie/02_theorie-landkarte.tex}

\section{Organisationsentwicklung im Kontext digitaler Transformation}
\input{C_Inhalt/02_Theorie/02a_Organisationsentwicklung im Kontext digitaler Transformation}


\section{Generative KI in organisationalen Entscheidungsprozessen}
\input{C_Inhalt/02_Theorie/02b_Generative KI in organisationalen Entscheidungsprozessen}

\section{Self-Determination Theory im Arbeitskontext}
\input{C_Inhalt/02_Theorie/02d_Self-Determination Theory im Arbeitskontext}

\section{Kompetenzerleben im Arbeits- und Führungskontext}
\input{C_Inhalt/02_Theorie/02e_Kompetenzerleben im Arbeits- und Führungskontext}

\section{Wahrgenommene Unterstützungsqualität als vermittelnder Mechanismus}
\input{C_Inhalt/02_Theorie/02f_Wahrgenommene Unterstützungsqualität als vermittelnder Mechanismus}


\section{Kontextbedingungen und theoretische Grenzziehung}
\input{C_Inhalt/02_Theorie/02g_kontextbedingungen}
