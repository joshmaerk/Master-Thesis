...
Generative KI transformiert Wissensarbeit durch die Bereitstellung kognitiver Unterstützung auf Abruf, die sowohl die Zusammensetzung von Aufgaben als auch die Bewertung menschlicher Fähigkeiten verändert. Empirische Feldstudien dokumentieren substanzielle Produktivitätseffekte: In einer gestaffelten Einführung eines konversationellen KI-Assistenten bei 5.000 Kundenservice-Mitarbeitern stieg die Anzahl gelöster Anfragen pro Stunde um etwa \textbf{14\%} \parencite{brynjolfsson_generative_2023}. Bemerkenswert ist die Verteilung dieser Gewinne: Die größten Produktivitätssteigerungen zeigten sich bei weniger erfahrenen Mitarbeitern, während hochqualifizierte Experten kaum profitierten. Dieses Muster illustriert den augmentativen Charakter generativer KI, die nicht uniform automatisiert, sondern gezielt Kompetenzlücken adressiert und damit die Leistungsverteilung innerhalb von Teams komprimiert.
...
%\subsection{SDT im Arbeitskontext: Empirische Evidenz}

Die Anwendung der SDT im Arbeitskontext ist gut etabliert und empirisch fundiert:
...
%\subsection{SDT und technologische Systeme}

Die Anwendung der SDT auf technologische Kontexte ist ein wachsendes Forschungsfeld:
...
Während mehrere theoretische Frameworks für die Untersuchung von KI im Arbeitskontext relevant sind, bietet die SDT spezifische Vorteile:
...
Dieses Modell postuliert einen indirekten Effekt: Die Nutzung generativer KI beeinflusst das Kompetenzerleben indirekt über die wahrgenommene Unterstützungsqualität. Diese Mediationshypothese ist theoretisch fundiert in der SDT-Annahme, dass Kontextfaktoren (hier: Technologiewahrnehmung) die Befriedigung psychologischer Grundbedürfnisse beeinflussen.
...
\textbf{Kapitel 5 – Diskussion:} Das Diskussionskapitel interpretiert die empirischen Befunde vor dem Hintergrund der theoretischen Grundlagen und des Forschungsstands. Es umfasst: (1) Zusammenfassung und Interpretation der Hauptbefunde; (2) Theoretische Implikationen für SDT und organisationale KI-Forschung; (3) Praktische Implikationen für Organisationen und HR-Management; (4) Limitationen der Studie; (5) Ansatzpunkte für zukünftige Forschung.
